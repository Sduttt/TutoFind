...
const OtherDetails = () => {
  ...
  const { prevStep, setData, updateProfile, data, uploadResume } = useSignupStore();
      ...
      >
                ...
                otherLanguages.map(lang => (
                  ...
                  >
                    <Text className="text-blue-700 text-sm font-medium">
                      {otherLangItems.find(item => item.value === lang)?.label}
                    </Text>
                    <TouchableOpacity
                      onPress={() =>
        ...
        {user_type === 'tutor' && (
          <View className="mb-8">
            ...
            >
              {/* TODO: 1-> RESUME UPLOAD NOT WORKKING, ALSO SHOW THE SELECTED FILE IN THIS FIELD */}
        ...
        {/* Submit Button */}
        <TouchableOpacity onPress={handleCompleteProfile} className="bg-blue-600 rounded-xl py-4 items-center shadow-lg active:bg-blue-700 mb-8">
